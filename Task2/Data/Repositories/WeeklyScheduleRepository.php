...
function CreateNewTable() : bool
    {
        $sql = "CREATE TABLE WeeklySchedule (id INTEGER AUTO_INCREMENT PRIMARY KEY, Dayd VARCHAR(130), StartTime VARCHAR(130), 
    ...
    function AddValues($id, $Item)
    {
        ...
        $sql = "INSERT INTO WeeklySchedule (id, Dayd, StartTime, CourseName) VALUES ($id+1, {$stringValue})";
